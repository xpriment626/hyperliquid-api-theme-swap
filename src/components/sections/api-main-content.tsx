        ...
        {!securityNoticeCollapsed && (
          <Alert className="relative bg-accent border-border">
            <button
              ...
              className="absolute -top-3 -left-3 z-10 inline-grid place-items-center h-7 w-7 rounded-full bg-muted/30 text-foreground hover:bg-muted/60 transition-transform duration-200 hover:scale-110"
            >
              <X className="h-4 w-4" />
            </button>
